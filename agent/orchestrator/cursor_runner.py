...
- Если вопрос про вакансии/отклики — опирайся на снимок выше и на код в /opt/personal-stack.
- Сопроводительные письма обычно уже перехвачены ботом в `/cover` (id / URL / вставленный текст). Если всё же пишешь сопровод сам:
  - прочитай `agent/skills/cover-letter/SKILL.md`;
  - HH: цель 900-1500 символов (лимит 400/500 — миф; технически до 10k);
  - предлог «в» для компаний (в X5, в Citilink, в НЛМК), не «на»;
  - один кейс под JD, без AI-slop и длинного тире.
