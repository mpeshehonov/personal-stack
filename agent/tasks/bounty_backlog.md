...
- [ ] **BB-05** `finance/bounty_payout.py` — log accepted bounty rewards to `finance_log` (mirror `a4_sales.py`)
- [ ] **BB-06** Weekly program suggestion in daily log: rotate away from low-response programs
