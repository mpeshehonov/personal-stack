...
- [ ] **IB-16** A4: crypto checkout webhook on site (NOWPayments/Cryptomus) → USDT + auto delivery link; **not Gumroad** — routes deployed 2026-07-10; needs `secrets/.env.checkout` + sandbox IPN test + `checkout_sync`
